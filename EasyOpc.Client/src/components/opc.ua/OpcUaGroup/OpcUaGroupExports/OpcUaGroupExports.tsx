...
import { OpcUaGroupWorkData, ExportToFileWorkSetting } from "../../../../types/opc.ua";
...
type OpcUaGroupExportsProps = {
  opcUaServerId: string;
  opcUaGroupId: string;
};

export const OpcUaGroupExports = (props: OpcUaGroupExportsProps) => {
  ...
  useEffect(() => {
    if(opcUaGroupWorks == null){
      getOpcUaGroupWorks(dispatch, props.opcUaGroupId, [ "EXPORT_TO_FILE" , "EXPORT_TO_SQL"])
  ...
  return (
    <Paper className={classes.paper}>
      ...
      {editOpcUaGroupWork && <EditExportModal work={editOpcUaGroupWork} okHandle={okHandle} closeHandle={closeHandle} />}
    </Paper>
  );
};
