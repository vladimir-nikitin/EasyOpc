...
import { ExportToFileWorkSetting, OpcDaGroupWorkData } from "../../../../types/opc.da";
...
type EditExportModalProps = {
  work: OpcDaGroupWorkData;
  okHandle: (work: OpcDaGroupWorkData) => void;
  closeHandle: () => void;
};
...
export const EditExportModal = (props: EditExportModalProps) => {
  ...
  const [work, setWork] = useState<OpcDaGroupWorkData>(props.work);
