...
import { OpcDaGroupWorkData, SubscritionToFileWorkSetting } from "../../../../types/opc.da";
...
type OpcDaGroupSubscritionsProps = {
  opcDaServerId: string;
  opcDaGroupId: string;
};

export const OpcDaGroupSubscritions = (props: OpcDaGroupSubscritionsProps) => {
  ...
  useEffect(() => {
    if(opcDaGroupWorks == null){
      getOpcDaGroupWorks(dispatch, props.opcDaGroupId, [ "SUBSCRITION_TO_FILE" , "SUBSCRITION_TO_SQL"])
  ...
  return (
    <Paper className={classes.paper}>
      ...
      {editOpcDaGroupWork && <EditSubscritionModal work={editOpcDaGroupWork} okHandle={okHandle} closeHandle={closeHandle} />}
    </Paper>
  );
};
